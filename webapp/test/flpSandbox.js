		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comcravecontractmanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcravecontractmanager-display": {
								"semanticObject": "comcravecontractmanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.crave.contractmanager",
									"url": sap.ui.require.toUrl("com/crave/contractmanager")
								}
							}
						}
					}
